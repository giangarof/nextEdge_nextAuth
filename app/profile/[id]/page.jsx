...
const Profile = async () => {
  ...
  const profile = await User.findById(userSession.userId)
    .select("role company")
    .lean();
    ...
    <>
      <div className="min-h-screen bg-gray-50 py-10">
        ...
        <div className="max-w-4xl mx-auto bg-white shadow-md rounded-2xl p-8 text-center mb-10">
          <div className="flex flex-col items-center">
            ...
            <Link
              ...
              className="cursor-pointer mt-4 px-6 py-2 bg-blue-600 text-white font-medium rounded-lg"
            >
              edit profile
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">My Jobs</h2>
